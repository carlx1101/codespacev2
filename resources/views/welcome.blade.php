...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="{{asset('dist/assets/img/codespace/icon.png')}}">
  ...
  <link rel="stylesheet" href="{{asset('dist/assets/vendor/hs-mega-menu/dist/hs-mega-menu.min.css')}}">
  <link rel="stylesheet" href="{{asset('dist/assets/vendor/swiper/swiper-bundle.min.css')}}">
...
<body>
    ...
    <div class="container">
      <nav class="js-mega-menu navbar-nav-wrap">
        ...
        <a class="navbar-brand" href="../demo-course/index.html" aria-label="Front">
          <img class="navbar-brand-logo" src="{{asset('dist/assets/img/codespace/logo.png')}}" alt="Logo">
        </a>
        <!-- End Default Logo -->
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <!-- Search Form -->
            <li class="nav-item flex-grow-1 d-none d-lg-inline-block px-5 py-3 ">
              <form class="input-group input-group-merge">
  ...
  <main id="content" role="main">
    ...
    <div class="container content-space-2">
      <div class="row justify-content-md-between align-items-sm-center">
        <div class="col-8 col-sm-6 col-md-5 mb-5 mb-sm-0">
          <img class="img-fluid" src="{{asset('dist/assets/svg/illustrations/oc-growing.svg')}}" alt="Image Description">
        </div>
        <!-- End Col -->
    ...
    <!-- Card Grid -->
    <div class="content-space-b-2 content-space-b-lg-3 bg-img-start" style="background: url({{asset('dist/assets/svg/components/shape-5.svg')}}) center no-repeat;">
            ...
            <div class="js-swiper-course-hero swiper">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide pt-2">
                  <!-- Card -->
                  <a class="card card-sm card-stretched-vertical card-transition bg-img-start" href="{{asset('dist/demo-course/course-overview.html')}}" style="background-image: url({{asset('dist/assets/img/400x500/img14.jpg')}}); min-height: 15rem;">
                    <div class="card-body">
                ...
                <div class="swiper-slide pt-2">
                  <!-- Card -->
                  <a class="card card-sm card-stretched-vertical card-transition bg-img-start" href="{{asset('dist/demo-course/course-overview.html')}}" style="background-image: url({{asset('dist/assets/img/400x500/img13.jpg')}}); min-height: 15rem;">
                    <div class="card-body">
                ...
                <div class="swiper-slide pt-2">
                  <!-- Card -->
                  <a class="card card-sm card-stretched-vertical card-transition bg-img-start" href="{{asset('dist/demo-course/course-overview.html')}}" style="background-image: url({{asset('dist/assets/img/400x500/img15.jpg')}}); min-height: 15rem;">
                    <div class="card-body">
                ...
                <div class="swiper-slide pt-2">
                  <!-- Card -->
                  <a class="card card-sm card-stretched-vertical card-transition bg-img-start" href="{{asset('dist/demo-course/course-overview.html')}}" style="background-image: url({{asset('dist/assets/img/400x500/img16.jpg')}}); min-height: 15rem;">
                    <div class="card-body">
                ...
                <div class="swiper-slide pt-2">
                  <!-- Card -->
                  <a class="card card-sm card-stretched-vertical card-transition bg-img-start" href="{{asset('dist/demo-course/course-overview.html')}}" style="background-image: url({{asset('dist/assets/img/400x500/img17.jpg')}}); min-height: 15rem;">
                    <div class="card-body">
                ...
                <div class="swiper-slide pt-2">
                  <!-- Card -->
                  <a class="card card-sm card-stretched-vertical card-transition bg-img-start" href="{{asset('dist/demo-course/course-overview.html')}}" style="background-image: url({{asset('dist/assets/img/400x500/img18.jpg')}}); min-height: 15rem;">
                    <div class="card-body">
...
<!-- End Card Grid -->
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 mb-5">
        <div class="col mb-5">
          ...
          <div class="card card-bordered h-100">
            ...
            <div class="card-pinned">
              <img class="card-img-top" src="{{asset('dist/assets/svg/components/card-12.svg')}}" alt="Image Description">
              ...
              <div class="card-pinned-bottom-start">
                <div class="d-flex align-items-center flex-wrap">
                  ...
                  <div class="d-flex gap-1">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                <h3 class="card-title">
                  <a class="text-dark" href="{{asset('dist/demo-course/course-overview.html')}}">Complete Python Bootcamp: Go from zero to hero in Python</a>
                </h3>
              </div>
                ...
                <div class="col">
                  <div class="avatar-group avatar-group-xs">
                    <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top" title="Nataly Gaga" href="#">
                      <img class="avatar-img" src="{{asset('dist/assets/img/160x160/img3.jpg')}}" alt="Image Description">
                    </a>
                  </div>
                </div>
                <!-- End Col --> 
        ...
        <div class="col mb-5">
          ...
          <div class="card card-bordered h-100">
            <!-- Card Pinned -->
            <div class="card-pinned">
              <img class="card-img-top" src="{{asset('dist/assets/svg/components/card-13.svg')}}" alt="Image Description">
                ...
                <div class="col">
                  <div class="avatar-group avatar-group-xs">
                    <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top" title="Emily Milda" href="#">
                      <img class="avatar-img" src="{{asset('dist/assets/img/160x160/img8.jpg')}}" alt="Image Description">
                    </a>
                    <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top" title="John O'nolan" href="#">
                      <img class="avatar-img" src="{{asset('dist/assets/img/160x160/img4.jpg')}}" alt="Image Description">
                    </a>
                  </div>
                </div>
                <!-- End Col --> 
        ...
        <div class="col mb-5">
          ...
          <div class="card card-bordered h-100">
            <!-- Card Pinned -->
            <div class="card-pinned">
              <img class="card-img-top" src="{{asset('dist/assets/svg/components/card-6.svg')}}" alt="Image Description">
              ...
              <div class="card-pinned-bottom-start">
                <div class="d-flex align-items-center flex-wrap">
                  ...
                  <div class="d-flex gap-1">
                    ...
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star-half.svg')}}" alt="Review rating" width="16">
                  </div>
                  <!-- End Rating -->
                  <div class="ms-1">
                ...
                <div class="col">
                  <div class="avatar-group avatar-group-xs">
                    ...
                    <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top" title="Hanna Wolfe" href="#">
                      <img class="avatar-img" src="{{asset('dist/assets/img/160x160/img7.jpg')}}" alt="Image Description">
                    </a>
                  </div>
                </div>
                <!-- End Col --> 
        ...
        <div class="col mb-5">
          ...
          <div class="card card-bordered h-100">
            <!-- Card Pinned -->
            <div class="card-pinned">
              <img class="card-img-top" src="{{asset('dist/assets/svg/components/card-15.svg')}}" alt="Image Description">
              ...
              <div class="card-pinned-bottom-start">
                <div class="d-flex align-items-center flex-wrap">
                  ...
                  <div class="d-flex gap-1">
                    ...
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star.svg')}}" alt="Review rating" width="16">
                    <img src="{{asset('dist/assets/svg/illustrations/star-muted.svg')}}" alt="Review rating" width="16">
                  </div>
                  <!-- End Rating -->
                  <div class="ms-1">
        ...
        <div class="col mb-5">
          ...
          <div class="card card-bordered h-100">
            <!-- Card Pinned -->
            <div class="card-pinned">
              <img class="card-img-top" src="{{asset('dist/assets/svg/components/card-4.svg')}}" alt="Image Description">
        ...
        <div class="col mb-5">
          ...
          <div class="card card-bordered h-100">
            <!-- Card Pinned -->
            <div class="card-pinned">
              <img class="card-img-top" src="{{asset('dist/assets/svg/components/card-14.svg')}}" alt="Image Description">
    ...
    <div class="overflow-hidden content-space-2">
      <div class="position-relative bg-light text-center rounded-2 zi-2 mx-3 mx-md-10">
        <div class="container content-space-2">
          ...
          <figure class="w-md-75 text-center mx-md-auto">
            ...
            <figcaption class="blockquote-footer mt-2">
              Carl
              <span class="blockquote-footer-source">Software Engineer</span>
            </figcaption>
          </figure>
          <!-- End Blockquote -->
        </div>
        ...
        <figure class="position-absolute bottom-0 end-0 mb-n7 me-n7" style="width: 10rem;">
          <img class="img-fluid" src="{{asset('dist/assets/svg/components/dots.svg')}}" alt="Image Description">
        </figure>
        <!-- End SVG Shape -->
      </div>
    </div>
  ...
  <footer class="bg-dark">
    <div class="container pb-1 pb-lg-5">
      <div class="row content-space-t-2">
        <div class="col-lg-3 mb-7 mb-lg-0">
          ...
          <ul class="list-unstyled list-py-1">
            <li><a class="link-sm link-light" href="#"><i class="bi-geo-alt-fill me-1"></i>Kuala Lumpur, Malaysia</a></li>
            <li><a class="link-sm link-light" href="tel:1-062-109-9222"><i class="bi-telephone-inbound-fill me-1"></i> +60 18278-6997</a></li>
          </ul>
          <!-- End List -->
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-soft-light btn-xs dropdown-toggle" id="footerSelectLanguage" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
                  <span class="d-flex align-items-center">
                    <img class="avatar avatar-xss avatar-circle me-2" src="{{asset('dist/assets/vendor/flag-icon-css/flags/1x1/us.svg')}}" alt="Image description" width="16"/>
                ...
                <div class="dropdown-menu" aria-labelledby="footerSelectLanguage">
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="{{asset('dist/assets/vendor/flag-icon-css/flags/1x1/de.svg')}}" alt="Image description" width="16"/>
                    <span>Deutsch</span>
                  </a>
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="{{asset('dist/assets/vendor/flag-icon-css/flags/1x1/es.svg')}}" alt="Image description" width="16"/>
                    <span>Español</span>
                  </a>
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <img class="avatar avatar-xss avatar-circle me-2" src="{{asset('dist/assets/vendor/flag-icon-css/flags/1x1/cn.svg')}}" alt="Image description" width="16"/>
                    <span>中文 (繁體)</span>
                  </a>
                </div>
              </div>
      ...
      <div class="w-md-85 text-lg-center mx-lg-auto">
        <p class="text-white-50 small">&copy; CodeSpace. 2022 UniSoft. All rights reserved.</p>
    ...
    <div class="offcanvas-body">
      ...
      <div id="loginOffcanvasFormLogin">
        ...
        <div class="text-center mb-7">
          <h3 class="modal-title">Log in to CodeSpace</h3>
          ...
          <div class="d-grid gap-3 text-center">
            ...
            <button type="submit" class="btn btn-ghost-secondary">
              <span class="d-flex justify-content-center align-items-center">
                <img class="avatar avatar-xss me-2" src="{{asset('dist/assets/svg/brands/google-icon.svg')}}" alt="Image Description">
                Log in with Google
              </span>
            </button>
  ...
  <script src="{{asset('dist/assets/vendor/hs-header/dist/hs-header.min.js')}}"></script>
  <script src="{{asset('dist/assets/vendor/hs-mega-menu/dist/hs-mega-menu.min.js')}}"></script>
  <script src="{{asset('dist/assets/vendor/hs-show-animation/dist/hs-show-animation.min.js')}}"></script>
  <script src="{{asset('dist/assets/vendor/hs-go-to/dist/hs-go-to.min.js')}}"></script>
  <script src="{{asset('dist/assets/vendor/typed.js/lib/typed.min.js')}}"></script>
  <script src="{{asset('dist/assets/vendor/fslightbox/index.js')}}"></script>
